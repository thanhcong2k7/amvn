      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <InfoCard title="Content Creators (YouTube, Twitch, etc.)">
            You can use our music in your videos/streams. Please provide credit in your description by linking to the track on Spotify or our website. Note that <b>none</b> of our tracks are registered with Content ID, so feel free to monetize your videos!
          </InfoCard>
